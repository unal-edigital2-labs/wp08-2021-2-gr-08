...
# pwm:0
set_property LOC H4 [get_ports {pwm}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm}]

# trigg:0
set_property LOC G13 [get_ports {trigg}]
set_property IOSTANDARD LVCMOS33 [get_ports {trigg}]

# ECHO:0
set_property LOC H16 [get_ports {ECHO}]
set_property IOSTANDARD LVCMOS33 [get_ports {ECHO}]

# infras:0
set_property LOC K1 [get_ports {infras0}]
set_property IOSTANDARD LVCMOS33 [get_ports {infras0}]

# infras:1
set_property LOC F6 [get_ports {infras1}]
set_property IOSTANDARD LVCMOS33 [get_ports {infras1}]

# infras:2
set_property LOC J2 [get_ports {infras2}]
set_property IOSTANDARD LVCMOS33 [get_ports {infras2}]

# infras:3
set_property LOC E7 [get_ports {infras3}]
...
# uart1:0.tx
set_property LOC G6 [get_ports {uart1_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart1_tx}]

# uart1:0.rx
set_property LOC E6 [get_ports {uart1_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart1_rx}]

# uart2:0.tx
set_property LOC G16 [get_ports {uart2_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart2_tx}]

# uart2:0.rx
set_property LOC H14 [get_ports {uart2_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart2_rx}]

# uart3:0.tx
set_property LOC H1 [get_ports {uart3_tx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart3_tx}]

# uart3:0.rx
set_property LOC G1 [get_ports {uart3_rx}]
set_property IOSTANDARD LVCMOS33 [get_ports {uart3_rx}]
